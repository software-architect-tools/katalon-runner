...
public class ObjectRepository {
    ...
    // issue:
    // https://forum.katalon.com/t/groovy-error-unable-to-resolve-class-internal-globalvariable/9557/64
    // source from : https://github.com/katalon-studio/katalon-studio-testing-framework
    // disable this to fix the related issue
    // try {
    // ScriptEngine scriptEngine = ScriptEngine.getDefault(ObjectRepository.class.getClassLoader());
    // variablesStringMap.put("GlobalVariable",
    // scriptEngine.runScriptWithoutLogging("internal.GlobalVariable", new Binding()));
