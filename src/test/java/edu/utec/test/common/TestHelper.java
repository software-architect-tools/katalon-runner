...
public class TestHelper {
  ...
  public static String getFileAsString(Object testeInstance, String fileName) {
    ...
    InputStream inputStreamGlobals = classLoader.getResourceAsStream(absoluteClasapathLocation);
